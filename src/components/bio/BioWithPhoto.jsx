        ...
        <div className='md:w-2/3 h-auto md:p-4 flex items-center'>
          <div className="flex flex-col">
            <p className='text-black font-medium text-justify'>
              ...
              dándole origen a su gran agrupación: “Cumbia Mestiza"
            </p>
            ...
            <p className='text-black font-medium text-justify pt-2'>
            zonte más cercano, pretenden seguir difundiendo su música por Hispanoamérica y Europa, para realizar presentaciones de su más reciente album “PARCEROS”, producido en Guanajuato Capital - Mexico.
            </p>
          </div>
        </div>
      </div>
