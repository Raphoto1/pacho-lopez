      ...
      <div className='hero-content w-full justify-start'>
        <div className='flex flex-col gap-4'>
          <a
            ...
            target='_blank'
            className='bg-fit bg-gray-800/50 rounded-full p-2'>
            <AiOutlineSpotify size={25} />
          </a>
          <a
            href='https://music.amazon.com.mx/tracks/B0CMK45DYK?marketplaceId=A1AM78C64UM0Y8&musicTerritory=MX&ref=dm_sh_Y3f13pVMRr2UjbzeUSnLikQXJ'
            target='_blank'
            className='bg-fit bg-gray-800/50 rounded-full p-2'>
            <SiAmazonmusic size={25} />
          </a>
          <a
            href='https://soundcloud.com/pacho-lopez-parra/cumbia-mestiza?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing'
            target='_blank'
            className='bg-fit bg-gray-800/50 rounded-full p-2'>
