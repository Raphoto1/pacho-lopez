...
export default function HeroImageDynamic({ imageUrl }) {
  return (
    <section className='hero min-h-screen relative z-0'>
      <div className='hero-overlay absolute inset-0 flex justify-center align-middle'>
        <img 
          src={imageUrl || '/img/photos/pacho2.jpg'}
          alt='artist' 
          className="w-auuto h-full object-cover justify-center"
        />
      </div>
